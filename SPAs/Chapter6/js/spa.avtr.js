...
spa.avtr = (function () { 
  ...
  // Begin utility method /getRandRgb/
  getRandRgb = function() {
    var i, rgb_list = [];
    for ( i = 0; i < 3; i++ ) {
  ...
  // End event handler /onTapNav/

  // Begin event handler /onHeldstartNav/
  ...
  // End event handler /onHeldstartNav/

  // Begin event handler /onHeldmoveNav/
  ...
  // End event handler /onHeldmoveNav/

  // Begin event handler /onHeldendNav/
  ...
  // End event handler /onHeldendNav/

  // Begin event handler /onSetchatee/
  ...
  // End event handler /onSetchatee/

  // Begin event handler /onListchange/
  ...
  // End event handler /onListchange/
  ...
  initModule = function ( $container ) {
    ...
    // bind model global events first
